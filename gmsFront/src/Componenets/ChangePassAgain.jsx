    ...
    <div className="change-password-parent-container">
      <div className="change-password-container">
        <form onSubmit={handleSubmit} >
          ...
          {oldPasswordErr && <p style={{ color: "red", fontSize:"large", marginTop:"auto" }}>*{oldPasswordErr}</p>}
          <div>
          ...
          {confirmPasswordErr && <p style={{ color: "red", fontSize:"large", marginTop:"auto" }}>*{confirmPasswordErr}</p>}
